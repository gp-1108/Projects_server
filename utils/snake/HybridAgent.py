...
class HybridAgent(BaselineAgent, DQNAgent):
    """
    ...
    """
    def __init__(self, boards_sample, onnx_path, alpha=0.1, gamma=0.95, epsilon=1.0, decay=0.99, threshold=5):
        """
        ...
        DQNAgent.__init__(self, boards_sample, onnx_path, alpha, gamma, epsilon, decay)
